...
/*
  ну ≥ €к же без костил€, на €кому держитьс€ весь прод
  баг пол€гаЇ в тому, що перший ≥ другий р€док €когось бен€ м≥н€ютьс€ м≥сц€ми
  тому сорторуюЇмо вже вдруге, ≥ виправл€Їм цю помилку
*/
    for(int i = 0; i <= X; i++){
      if(SumMatrix(matr,i,X,Y,0) > SumMatrix(matr,i + 1,X,Y,0)){
         Matrix_XY_Reverse(matr,X,Y,i,i + 1,0);
...
/*
  ну ≥ €к же без костил€ #2, на €кому держитьс€ весь прод
  баг пол€гаЇ в тому, що перший ≥ другий р€док €когось бен€ м≥н€ютьс€ м≥сц€ми
  тому сорторуюЇмо вже вдруге, ≥ виправл€Їм цю помилку
*/
    for(int i = 0; i <= Y; i++){
